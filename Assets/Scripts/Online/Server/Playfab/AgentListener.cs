...
public class AgentListener : MonoBehaviour {
    ...
    [SerializeField] private UnityNetworkServer _server;
    ...
    public void OnPlayerRemoved(string playfabId)
    {
        ...
        Debug.Log("Remove ! Nombre de joueur = " + _connectedPlayers.Count);
        OnShutdown();
    ...
    public void OnPlayerAdded(string playfabId)
    {
        ...
        PlayFabMultiplayerAgentAPI.UpdateConnectedPlayers(_connectedPlayers);
        Debug.Log("ADD ! Nombre de joueur = " + _connectedPlayers.Count);
